...
<div class="track-wrapper">
    ...
    <nav aria-label="Songs per track">
      <ul class="pagination justify-content-center">
        <li class="page-item <?php ($nrSongs == 5) ? echo 'disabled active' : ''; ?>" >
            <a class="page-link" href="tracks.php?s=5" <?php ($nrSongs == 5) ? echo 'tabindex="-1"' : ''; ?> >5</a>
        </li>
        <li class="page-item <?php ($nrSongs == 10) ? echo 'disabled active' : ''; ?>" >
            <a class="page-link" href="tracks.php?s=10" <?php ($nrSongs == 10) ? echo 'tabindex="-1"' : ''; ?> >10</a>
        </li>
        <li class="page-item <?php ($nrSongs == 15) ? echo 'disabled active' : ''; ?>" >
            <a class="page-link" href="tracks.php?s=15" <?php ($nrSongs == 15) ? echo 'tabindex="-1"' : ''; ?> >15</a>
        </li>
      </ul>
    </nav>
